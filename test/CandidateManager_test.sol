...
contract CandidateManagerTest {
    ...
    // ==========================================
    // 6. Test khóa danh sách ứng viên
    // ==========================================
    ...
    // ==========================================
    // 7. Test không được thêm sau khi khóa
    // ==========================================
    ...
    // ==========================================
    // 8. Test không được sửa sau khi khóa
    // ==========================================
    ...
    // ==========================================
    // 9. Test không được xóa sau khi khóa
    // ==========================================
    ...
    // ==========================================
    // 10. Test điều kiện khóa danh sách
    // ==========================================
    ...
    function testCandidateVoteCountThroughVotingCore() public {
        ...
        // Thiết lập VotingCore cho CandidateManager
        manager.setVotingCore(
            address(core)
        );
        ...
        // Đăng ký test contract làm cử tri
        registry.registerVoter(
            address(this)
        );

        // Khóa danh sách ứng viên
        manager.lockCandidates();

        // Bắt đầu cuộc bầu cử
        scheduler.startElection();

        // Bỏ phiếu cho ứng viên có ID = 0
        core.vote(0);
